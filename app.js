...
app.get('/admincustomer/:id', (req, res) => {
  ...
  .then((result)=>{
      ...
      console.log(result.rows[0].dateko);
  })
  .catch((err) => {
    console.log('error',err);
